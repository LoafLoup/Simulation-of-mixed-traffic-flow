...
本仓库用于仿真混合交通流场景下的安全水平，源于 [10.1016/j.physa.2024.129802](https://doi.org/10.1016/j.physa.2024.129802)，核心脚本为 `simulation_safety.m`。脚本通过随机生成不同类型车辆，模拟车辆跟驰行为，并基于速度、位置和加速度数据计算交通安全评价指标。
